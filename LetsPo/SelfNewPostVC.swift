...
class SelfNewPostVC: UIViewController,UINavigationControllerDelegate,UIImagePickerControllerDelegate ,UICollectionViewDelegate ,UICollectionViewDataSource{
    ...
    let resetNote = Notification.Name("resetSelfNote")
    var bgImage = UIImage()
